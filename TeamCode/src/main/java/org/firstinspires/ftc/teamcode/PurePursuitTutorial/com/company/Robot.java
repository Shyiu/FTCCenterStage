...
public class Robot {
    ...
    public void update(){
        ...
        worldAngle_rad += RobotUtilities.MovementVars.movement_turn * elapsedTime * 20 / (2 * Math.PI);


        xSpeed += Range.clip((RobotUtilities.MovementVars.movement_x-xSpeed)/0.2,-1,1) * elapsedTime;
        ySpeed += Range.clip((RobotUtilities.MovementVars.movement_y-ySpeed)/0.2,-1,1) * elapsedTime;
        turnSpeed += Range.clip((RobotUtilities.MovementVars.movement_turn-turnSpeed)/0.2,-1,1) * elapsedTime;
